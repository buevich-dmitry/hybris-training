 ...
 */
package com.expertsoft.merchandise.core.constants;

/**
 * Global class for all EsCore constants. You can add global constants for your extension into this class.
 */
public final class EsCoreConstants extends GeneratedEsCoreConstants
{
	public static final String EXTENSIONNAME = "escore";


	private EsCoreConstants()
	{
		//empty
	}
