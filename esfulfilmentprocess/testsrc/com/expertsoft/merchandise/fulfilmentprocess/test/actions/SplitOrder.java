 ...
 */
package com.expertsoft.merchandise.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(EsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EsFulfilmentProcessConstants.PARENT_PROCESS);
