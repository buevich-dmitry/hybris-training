 ...
 */
package com.expertsoft.merchandise.cockpits.setup;
...
import com.expertsoft.merchandise.cockpits.constants.EsCockpitsConstants;
 ...
 */
@SystemSetup(extension = EsCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/escockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
