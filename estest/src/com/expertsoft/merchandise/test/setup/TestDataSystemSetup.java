 ...
 */
package com.expertsoft.merchandise.test.setup;
...
import com.expertsoft.merchandise.test.constants.EsTestConstants;
import com.expertsoft.merchandise.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/estest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/estest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/estest/import/cstickets.impex");
			...
			importImpexFile(context, "/estest/import/csquotes.impex");
		}
	}
}
