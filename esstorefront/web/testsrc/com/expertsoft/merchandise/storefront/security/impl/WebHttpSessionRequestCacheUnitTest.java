...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/esstorefront/electronics/en",
						"https://electronics.local:9002/esstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/esstorefront/electronics/en",
						"https://electronics.local:9002/esstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/esstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/esstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/esstorefront/electronics/en",
						"https://electronics.local:9002/esstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/esstorefront",
						"https://electronics.local:9002/esstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/esstorefront",
						"https://electronics.local:9002/esstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/esstorefront/electronics/en",
						"https://electronics.local:9002/esstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
